    ...
    fn from(info_and_sender: (MessageInfo, Badge)) -> Self {
        ...
        match info.label() {
            ...
            UNKNOWN_SYSCALL => Fault::UnknownSyscall(UnknownSyscall {
                sender,
                r0: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_R0 as usize],
                r1: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_R1 as usize],
                r2: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_R2 as usize],
                r3: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_R3 as usize],
                r4: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_R4 as usize],
                r5: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_R5 as usize],
                r6: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_R6 as usize],
                r7: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_R7 as usize],
                ...
                current_program_status_register: buffer.msg[seL4_UnknownSyscall_Msg_seL4_UnknownSyscall_CPSR as usize],
            ...
            USER_EXCEPTION => Fault::UserException(UserException {
                ...
                current_program_status_register: buffer.msg[seL4_UserException_Msg_seL4_UserException_CPSR as usize],
